    ...
    <div className="flex flex-col grow p-6">
      ...
      <form className="grow flex flex-col"
        ...
        {details != null && <Fragment>
          ...
          <div className="text-default-contrast">
            {Lang.match({ en: "The full details of the request in a structured format. You can copy and share it with an AI to get an explanation or ask for advice.", zh: "请求的完整详细信息，采用结构化格式。您可以复制并与 AI 共享，以获取解释或寻求建议。", hi: "संरचित प्रारूप में अनुरोध का पूरा विवरण। आप इसे कॉपी कर सकते हैं और एक AI के साथ साझा कर सकते हैं ताकि व्याख्या प्राप्त कर सकें या सलाह मांग सकें।", es: "Los detalles completos de la solicitud en un formato estructurado. Puede copiarlo y compartirlo con una IA para obtener una explicación o pedir consejo.", ar: "التفاصيل الكاملة للطلب بتنسيق منظم. يمكنك نسخه ومشاركته مع AI للحصول على شرح أو طلب نصيحة.", fr: "Les détails complets de la requête dans un format structuré. Vous pouvez le copier et le partager avec une IA pour obtenir une explication ou demander des conseils.", de: "Die vollständigen Details der Anfrage in einem strukturierten Format. Sie können es kopieren und mit einer KI teilen, um eine Erklärung zu erhalten oder um Rat zu fragen.", ru: "Полные детали запроса в структурированном формате. Вы можете скопировать его и поделиться с ИИ, чтобы получить объяснение или попросить совет.", pt: "Os detalhes completos da solicitação em um formato estruturado. Você pode copiá-lo e compartilhá-lo com uma IA para obter uma explicação ou pedir conselhos.", ja: "構造化された形式でのリクエストの完全な詳細。コピーしてAIと共有し、説明を得たりアドバイスを求めたりできます。", pa: "ਸੰਰਚਿਤ ਫਾਰਮੈਟ ਵਿੱਚ ਬੇਨਤੀ ਦੇ ਪੂਰੇ ਵੇਰਵੇ। ਤੁਸੀਂ ਇਸਨੂੰ ਕਾਪੀ ਕਰਕੇ ਇੱਕ AI ਨਾਲ ਸਾਂਝਾ ਕਰ ਸਕਦੇ ਹੋ ਤਾਂ ਜੋ ਵਿਆਖਿਆ ਪ੍ਰਾਪਤ ਕਰ ਸਕੋ ਜਾਂ ਸਲਾਹ ਮੰਗ ਸਕੋ।", bn: "সংগঠিত ফরম্যাটে অনুরোধের সম্পূর্ণ বিবরণ। আপনি এটি কপি করে একটি AI এর সাথে শেয়ার করতে পারেন যাতে একটি ব্যাখ্যা পেতে বা পরামর্শ চাইতে পারেন।", id: "Detail lengkap dari permintaan dalam format terstruktur. Anda dapat menyalinnya dan membagikannya dengan AI untuk mendapatkan penjelasan atau meminta saran.", ur: "درخواست کی مکمل تفصیلات ایک منظم فارمیٹ میں۔ آپ اسے کاپی کر سکتے ہیں اور ایک AI کے ساتھ شیئر کر سکتے ہیں تاکہ وضاحت حاصل کر سکیں یا مشورہ طلب کر سکیں۔", ms: "Detail lengkap dari permintaan dalam format terstruktur. Anda dapat menyalinnya dan membagikannya dengan AI untuk mendapatkan penjelasan atau meminta saran.", it: "I dettagli completi della richiesta in un formato strutturato. Puoi copiarlo e condividerlo con un'IA per ottenere una spiegazione o chiedere consigli.", tr: "İsteğin tam detayları yapılandırılmış bir formatta. Bir açıklama almak veya tavsiye istemek için kopyalayıp bir AI ile paylaşabilirsiniz.", ta: "கோரிக்கையின் முழு விவரங்கள் ஒரு கட்டமைக்கப்பட்ட வடிவத்தில். விளக்கம் பெற அல்லது ஆலோசனை கேட்க அதை நகலெடுத்து ஒரு AI உடன் பகிரக்கலாம்.", te: "అభ్యర్థన యొక్క పూర్తి వివరాలు ఒక నిర్మిత ఫార్మాట్‌లో. మీరు దీన్ని కాపీ చేసి AIతో పంచుకోవచ్చు వివరణ పొందడానికి లేదా సలహా అడగడానికి.", ko: "구조화된 형식으로 요청의 전체 세부 정보입니다. 설명을 얻거나 조언을 구하기 위해 복사하여 AI와 공유할 수 있습니다.", vi: "Chi tiết đầy đủ của yêu cầu ở định dạng có cấu trúc. Bạn có thể sao chép nó và chia sẻ với AI để nhận giải thích hoặc hỏi lời khuyên.", pl: "Pełne szczegóły żądania w ustrukturyzowanym formacie. Możesz go skopiować i udostępnić AI, aby uzyskać wyjaśnienie lub poprosić o radę.", ro: "Detaliile complete ale cererii într-un format structurat. Puteți să îl copiați și să îl partajați cu un AI pentru a obține o explicație sau a cere sfaturi.", nl: "De volledige details van het verzoek in een gestructureerd formaat. U kunt het kopiëren en delen met een AI om een uitleg te krijgen of om advies te vragen.", el: "Τα πλήρη στοιχεία του αιτήματος σε μια δομημένη μορφή. Μπορείτε να το αντιγράψετε και να το μοιραστείτε με ένα AI για να λάβετε μια εξήγηση ή να ζητήσετε συμβουλές ", th: "รายละเอียดทั้งหมดของคำขอในรูปแบบที่มีโครงสร้าง คุณสามารถคัดลอกและแชร์กับ AI เพื่อรับคำอธิบายหรือขอคำแนะนำได้", cs: "Úplné podrobnosti o požadavku ve strukturovaném formátu. Můžete jej zkopírovat a sdílet s AI, abyste získali vysvětlení nebo požádali o radu.", hu: "A kérés teljes részletei egy strukturált formátumban. Másolhatja és megoszthatja egy AI-val, hogy magyarázatot kapjon vagy tanácsot kérjen.", sv: "De fullständiga detaljerna för förfrågan i ett strukturerat format. Du kan kopiera det och dela det med en AI för att få en förklaring eller be om råd.", da: "De fuldstændige detaljer for anmodningen i et struktureret format. Du kan kopiere det og dele det med en AI for at få en forklaring eller bede om råd." })}
          </div>
          <div className="h-4" />
