    ...
    <div className="flex flex-col grow p-6">
      ...
      <form className="grow flex flex-col"
        ...
        <Fragment>
          ...
          <div className="h-4" />
          <div className="flex not-md:flex-col md:flex-row items-center border border-default-contrast rounded-xl py-6">
            <button className="group rounded-full p-2 not-md:hidden md:flex items-center justify-center rtl:-scale-x-100 enabled:hover:bg-default-double-contrast focus-visible:bg-default-double-contrast focus-visible:outline-none disabled:opacity-50"
