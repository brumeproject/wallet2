      ...
      <form className="grow flex flex-col"
        ...
        <Fragment>
          ...
          <div className="text-default-contrast">
            {Lang.match({ en: "Your sessions. Each session links your subaccount to some app that can send you signature and transaction requests.", zh: "您的会话。每个会话将您的子账户链接到某些应用程序，这些应用程序可以向您发送签名和交易请求。", hi: "आपके सत्र। प्रत्येक सत्र आपके उपखाते को कुछ ऐप से लिंक करता है जो आपको हस्ताक्षर और लेनदेन अनुरोध भेज सकता है।", es: "Tus sesiones. Cada sesión vincula tu subcuenta a alguna aplicación que puede enviarte solicitudes de firma y transacción.", ar: "جلساتك. كل جلسة تربط حسابك الفرعي ببعض التطبيقات التي يمكنها إرسال طلبات توقيع ومعاملات إليك.", fr: "Vos sessions. Chaque session lie votre sous-compte à une application qui peut vous envoyer des demandes de signature et de transaction.", de: "Ihre Sitzungen. Jede Sitzung verbindet Ihr Unterkonto mit einer App, die Ihnen Signatur- und Transaktionsanfragen senden kann.", ru: "Ваши сессии. Каждая сессия связывает ваш субсчет с некоторым приложением, которое может отправлять вам запросы на подпись и транзакцию.", pt: "Suas sessões. Cada sessão vincula sua subconta a algum aplicativo que pode enviar solicitações de assinatura e transação para você.", ja: "あなたのセッション。各セッションは、署名やトランザクションのリクエストを送信できるいくつかのアプリにあなたのサブアカウントをリンクします。", pa: "ਤੁਹਾਡੇ ਸੈਸ਼ਨ। ਹਰ ਸੈਸ਼ਨ ਤੁਹਾਡੇ ਉਪਖਾਤੇ ਨੂੰ ਕੁਝ ਐਪ ਨਾਲ ਜੋੜਦਾ है ਜੋ ਤੁਹਾਨੂੰ ਸਾਈਨ ਅਤੇ ਟ੍ਰਾਂਜ਼ੈਕਸ਼ਨ ਬੇਨਤੀਆਂ ਭੇਜ ਸਕਦਾ ਹੈ।", bn: "আপনার সেশনগুলি। প্রতিটি সেশন আপনার সাবঅ্যাকাউন্টকে কিছু অ্যাপ্লিকেশনের সাথে যুক্ত করে যা আপনাকে স্বাক্ষর এবং লেনদেনের অনুরোধ পাঠাতে পারে।", id: "Sesi Anda. Setiap sesi menghubungkan subakun Anda ke beberapa aplikasi yang dapat mengirimkan permintaan tanda tangan dan transaksi kepada Anda.", ur: "آپ کے سیشنز۔ ہر سیشن آپ کے سب اکاؤنٹ کو کچھ ایپس سے جوڑتا ہے جو آپ کو دستخط اور ٹرانزیکشن کی درخواستیں بھیج سکتی ہیں۔", ms: "Sesi Anda. Setiap sesi menghubungkan subakun Anda ke beberapa aplikasi yang dapat mengirimkan permintaan tanda tangan dan transaksi kepada Anda.", it: "Le tue sessioni. Ogni sessione collega il tuo sottoconto a qualche app che può inviarti richieste di firma e transazione.", tr: "Oturumlarınız. Her oturum, alt hesabınızı size imza ve işlem istekleri gönderebilecek bazı uygulamalara bağlar.", ta: "உங்கள் அமர்வுகள். ஒவ்வொரு அமர்வும் உங்கள் உபகணக்கை சில செயலிகளுடன் இணைக்கிறது, அவை உங்களுக்கு கையொப்பம் மற்றும் பரிவர்த்தனை கோரிக்கைகளை அனுப்ப முடியும்.", te: "మీ సెషన్లు. ప్రతి సెషన్ మీ ఉపఖాతాను కొన్ని యాప్‌లకు లింక్ చేస్తుంది, అవి మీకు సంతకం మరియు లావాదేవీ అభ్యర్థనలను పంపవచ్చు.", ko: "당신의 세션입니다. 각 세션은 당신의 하위 계정을 일부 앱에 연결하여 서명 및 거래 요청을 보낼 수 있습니다.", vi: "Các phiên của bạn. Mỗi phiên kết nối tài khoản phụ của bạn với một số ứng dụng có thể gửi yêu cầu ký và giao dịch cho bạn.", pl: "Twoje sesje. Każda sesja łączy Twój subkonto z jakąś aplikacją, która może wysyłać Ci prośby o podpis i transakcję.", ro: "Sesiunile tale. Fiecare sesiune leagă subcontul tău de unele aplicații care îți pot trimite cereri de semnătură și tranzacție.", nl: "Je sessies. Elke sessie koppelt je subaccount aan een app die je handtekening- en transactieaanvragen kan sturen.", el: "Οι συνεδρίες σας. Κάθε συνεδρία συνδέει τον υπολογαριασμό σας με ορισμένες εφαρμογές που μπορούν να σας στείλουν αιτήματα υπογραφής και συναλλαγών. ", th: "เซสชันของคุณ แต่ละเซสชันเชื่อมโยงบัญชีย่อยของคุณกับแอปบางตัวที่สามารถส่งคำขอการลงนามและธุรกรรมให้คุณได้ ", cs: "Vaše sezení. Každé sezení propojuje váš podúčet s nějakou aplikací, která vám může posílat požadavky na podpis a transakci. ", hu: "Munkameneteid. Minden munkamenet összekapcsolja az alszámládat néhány alkalmazással, amelyek aláírási és tranzakciós kérelmeket küldhetnek neked. ", sv: "Dina sessioner. Varje session länkar ditt underkonto till några appar som kan skicka signatur- och transaktionsförfrågningar till dig. ", da: "Dine sessioner. Hver session forbinder din underkonto til nogle apps, der kan sende dig anmodninger om signatur og transaktion." })}
          </div>
          <div className="h-4" />
