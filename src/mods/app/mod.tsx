        ...
        <div className="p-6 flex flex-col items-center w-full max-w-[1000px] m-auto">
          ...
          <div className="flex flex-col items-start w-full gap-4">
            ...
            <div className="bg-opposite text-opposite selection-opposite p-4 rounded-xl">
              {Lang.match({ en: "We have 7", zh: "我们有7个", hi: "हमारे पास 7 हैं", es: "Tenemos 7", ar: "لدينا 7", fr: "Nous en avons 7", de: "Wir haben 7", ru: "У нас есть 7", pt: "Temos 7", ja: "私たちは7を持っています", pa: "ਸਾਡੇ ਕੋਲ 7 ਹਨ", bn: "আমাদের কাছে 7 আছে", id: "Kami memiliki 7", ur: "ہمارے پاس 7 ہیں", ms: "Kami memiliki 7", it: "Ne abbiamo 7", tr: "Bizde 7 var", ta: "எங்களிடம் 7 உள்ளது", te: "మాకు 7 ఉన్నాయి", ko: "우리는 7개가 있습니다", vi: "Chúng tôi có 7", pl: "Mamy 7", ro: "Avem 7", nl: "We hebben er 7", el: "Έχουμε 7", th: "เรามี 7 คน", cs: "Máme jich 7", hu: "Nekünk van 7-ünk", sv: "Vi har 7 stycken", da: "Vi har 7" })}
            </div>
          </div>
          <div className="h-[50dvh]" />
